...
from dnsviz.util import TRUSTED_KEYS_ROOT, get_default_trusted_keys_with_sanity_check
...
class DVCommandLineQuery:
    ...
    def query_and_display(self, options):
        ...
        if self.trusted_keys_file is not None:
            ...
            if get_default_trusted_keys_with_sanity_check():
                dnsviz_args.extend(['-t', TRUSTED_KEYS_ROOT])
