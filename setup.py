...
setup(name='dnsviz',
        ...
        data_files=[
                ...
                ('share/dnsviz/css/redmond', ['external/jquery-ui/jquery-ui-1.11.4.custom.min.css']),
                ('share/dnsviz/css/redmond/images', glob.glob(os.path.join('external', 'jquery-ui', 'images', '*.png'))),
